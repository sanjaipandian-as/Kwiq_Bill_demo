 ...
 */
const BrandLockup = ({ width = 230, height = 60, style, variant = 'dark' }) => {
    ...
    return (
        ...
        >
            ...
            <Path fill={colors.kwiq} d="m103.1 107.2 5.93 19.23h5.52l4.35-12.98 4.35 12.98h4.6l5.92-19.23h-4.33l-4.09 13.61-4.62-13.87h-3.48l-4.97 13.73-4.21-13.47h-3.48l-4.97 13.73-4.21-13.47h-4.97z" />
